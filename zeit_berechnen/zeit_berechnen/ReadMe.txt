========================================================================
    KONSOLENANWENDUNG: zeit_berechnen-Projektübersicht
========================================================================

Diese zeit_berechnen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre zeit_berechnen-Anwendung besteht.


zeit_berechnen.vcxproj
...
zeit_berechnen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen zeit_berechnen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
