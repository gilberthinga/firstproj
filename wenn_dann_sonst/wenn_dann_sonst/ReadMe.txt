========================================================================
    KONSOLENANWENDUNG: wenn_dann_sonst-Projektübersicht
========================================================================

Diese wenn_dann_sonst-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre wenn_dann_sonst-Anwendung besteht.


wenn_dann_sonst.vcxproj
...
wenn_dann_sonst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen wenn_dann_sonst.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
