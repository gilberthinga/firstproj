========================================================================
    KONSOLENANWENDUNG: Zylinder_Funktionen-Projektübersicht
========================================================================

Diese Zylinder_Funktionen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Zylinder_Funktionen-Anwendung besteht.


Zylinder_Funktionen.vcxproj
...
Zylinder_Funktionen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Zylinder_Funktionen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
