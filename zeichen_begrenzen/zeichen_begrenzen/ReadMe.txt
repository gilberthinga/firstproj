========================================================================
    KONSOLENANWENDUNG: zeichen_begrenzen-Projektübersicht
========================================================================

Diese zeichen_begrenzen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre zeichen_begrenzen-Anwendung besteht.


zeichen_begrenzen.vcxproj
...
zeichen_begrenzen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen zeichen_begrenzen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
